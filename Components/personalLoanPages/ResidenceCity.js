...
export default function ResidenceCity() {
        ...
        <View style={styles.container}>
            ...
            <View style={{ paddingLeft: 20, paddingRight: 20 }}>
                <View style={{ marginTop: 20 }}>
                    ...
                    <Text style={{ textAlign: 'right', marginTop: -15 }}><Text style={styles.subHeading}>Step 5/8</Text></Text>
            ...
            <View style={{ marginTop: -50 }}>
                ...
                <Text style={{ textAlign: 'center', color: 'blue', marginTop: 60, fontWeight: 600, textDecorationLine: 'underline', }}>View All Cities</Text>
            </View>
        </View>
    );
}
