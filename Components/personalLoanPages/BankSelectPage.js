...
export default function BankSelectPage() {
    ...
    function movetoEmploymentDetailsPage() {
            ...
            <View style={{ marginTop: -50 }}>
                <RadioButton.Group onValueChange={(newValue) => setChecked(newValue)} value={checked}>
                    <View style={styles.row}>
                        <View style={styles.column} onTouchStart={() => (setChecked('hdfc'), movetoEmploymentDetailsPage())}>
                            <View style={styles.row}>
                                <View style={{ flex: 11 }}>
                        ...
                        <View style={styles.column} onTouchStart={() => (setChecked('sbi'), movetoEmploymentDetailsPage())}>
                            <View style={styles.row}>
                                <View style={{ flex: 11 }}>
                    ...
                    <View style={{ marginTop: 40 }}>
                        <View style={styles.row}>
                            <View style={styles.column} onTouchStart={() => (setChecked('icici'), movetoEmploymentDetailsPage())}>
                                <View style={styles.row}>
                                    <View style={{ flex: 11 }}>
                            ...
                            <View style={styles.column} onTouchStart={() => (setChecked('axis'), movetoEmploymentDetailsPage())}>
                                <View style={styles.row}>
                                    <View style={{ flex: 11 }}>
                    ...
                    <View style={{ marginTop: 40 }}>
                        <View style={styles.row}>
                            <View style={styles.column} onTouchStart={() => (setChecked('kotak'), movetoEmploymentDetailsPage())}>
                                <View style={styles.row}>
                                    <View style={{ flex: 11 }}>
                            ...
                            <View style={styles.column} onTouchStart={() => (setChecked('yesbank'), movetoEmploymentDetailsPage())}>
                                <View style={styles.row}>
                                    <View style={{ flex: 11 }}>
