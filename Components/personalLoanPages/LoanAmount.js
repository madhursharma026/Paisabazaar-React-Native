        ...
        <View style={styles.container}>
            ...
            <View style={{ paddingLeft: 20, paddingRight: 20 }}>
                <View style={{ marginTop: 20 }}>
                    ...
                    <Text style={{ textAlign: 'right', marginTop: -15 }}><Text style={styles.subHeading}>Step 7/8</Text></Text>

                    <View style={{ width: '80%', marginTop: 20 }}>
                        <Text style={styles.mainHeading}>Select your desired Personal Loan Amount</Text>
                    </View>
                </View>
            </View>
